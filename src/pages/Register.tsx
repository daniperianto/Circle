        ...
        <Center 
            ...
            <VStack 
                ...
                <FormControl onSubmit={ () => handleRegister()}>
                    <Input type="text" name="fullname" my={1} placeholder="Full Name*" color={'white'} borderColor={'#5C8374'} value={form.fullname}  onChange={handleChange} />
                    <Input type="email" name="email" my={1} placeholder="Email*" color={'white'} borderColor={'#5C8374'} value={form.email}  onChange={handleChange}/>
                    <Input type="password" name="password" my={1} placeholder="Password*" color={'white'} borderColor={'#5C8374'} value={form.password}  onChange={handleChange}/>
